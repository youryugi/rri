...
!	 if(Frn.ge.1.0) then !Fr?�E��E�?�E��E�?�E��E�?�E��E�ȏ�̏ꍇ
...
!	 pause'Frn>1.0'
	 ...
	 else !Frn?�E��E�?�E��E�?�E��E�?�E��E�ȉ�?�E��E�̏ꍇ
...
!----?�E��E�|?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�̌v?�E��E�Z
    do k = 1, riv_count
	  do m = 1, Np
!	   sed_idx(k)%ffd(m) = sed_idx(k)%qdsum(m)/width_idx(k)/dis_riv_idx(k) !?�E��E�P?�E��E�ʂ�[m/s]
	   sed_idx(k)%ffd(m) = sed_idx(k)%qdsum(m)/area_idx(k) !?�E��E�P?�E��E�ʂ�[m/s]
	  enddo
	enddo

    do k = 1, riv_count
!----?�E��E�?�E��E�?�E��E�V?�E��E�?�E��E�?�E��E�̑�?�E��E�?�E��E�?�E��E�Z
		kk = down_riv_idx(k)
...
!		sed_idx(k)%ffd(m) = sed_idx(k)%ffd(m)	!unlimted supply of suspended sediment; 2021/7/16
		...
		do m = 1, Np
			sed_idx(k)%ffd(m) = sed_idx(k)%ffd(m) + (sed_idx(k)%Esi(m) - sed_idx(k)%Dsi(m)) !?�E��E�P?�E��E�ʂ�[m/s]
		enddo	
	endif	

	  do m = 1, Np
	   sed_idx(k)%dzbpr(m) = - ddt * sed_idx(k)%ffd(m) * dlambda !?�E��E�P?�E��E�ʂ�[m]
...
!?�E��E�͏�?�E��E�ϓ�?�E��E�?�E��E�?�E��E�傫?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�?�E��E��E�??�E��E�C?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�}?�E��E�?�E��E�?�E��E�?�E��E�D(?�E��E�?�E��E�?�E��E�ꂼ?�E��E�?�E��E�̗�?�E��E�a?�E��E�ɂ�?�E��E�?�E��E�?�E��E�?�E��E�͏�?�E��E�ϓ�?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�l?�E��E�ɉ�?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�K?�E��E�v?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�D)
...
!pause'after call washsedi'
    ...
    do k = 1, riv_count
		 ...
		 if(Frn.ge.100.0) then 
!		 if(Frn.lt.1.0) then !!Fr?�E��E�?�E��E�?�E��E�?�E��E�ȏ�̏ꍇ
...
!		if(qr_ave_idx(k).le.1e-3) then !modified by Qin 2021/6/3
			...
			sed_idx(k)%ssi(m) = sed_idx(k)%ssi(m) - (-1.* sed_idx(k)%qsisum(m) + sed_idx(k)%Esi(m)*area_idx(k) - sed_idx(k)%Dsi(m)*area_idx(k)) * ddt/water_v_idx(k) !?�E��E�?�E��E�?�E��E�ɖ߂�?�E��E�?�E��E�
			sed_idx(k)%Dsi(m) = -1.* sed_idx(k)%qsisum(m)/area_idx(k) + sed_idx(k)%Esi(m)      !D?�E��E�?�E��E�?�E��E�C?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�
			if(sed_idx(k)%Dsi(m) < 0.) sed_idx(k)%Dsi(m) = 0.d0 !?�E��E�܂�D?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�̎�?�E��E�͏㉺?�E��E�?�E��E�?�E��E�̃A?�E��E�?�E��E�?�E��E�o?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�X?�E��E�ɂ�?�E��E�̂�D?�E��E�?�E��E�0?�E��E�ƂȂ�
			sed_idx(k)%ssi(m) = sed_idx(k)%ssi(m) + (-1.* sed_idx(k)%qsisum(m) + sed_idx(k)%Esi(m)*area_idx(k) - sed_idx(k)%Dsi(m)*area_idx(k)) * ddt/water_v_idx(k) !?�E��E�V?�E��E�?�E��E�?�E��E�?�E��E�D?�E��E�?�E��E�?�E��E�g?�E��E�?�E��E�?�E��E�Ă�?�E��E�?�E��E�?�E��E�?�E��E�xssi?�E��E�?�E��E�?�E��E�v?�E��E�Z
		 !----modified by Qin 2021/5/30
			 if(sed_idx(k)%ssi(m).lt.0.d0) then
				sed_idx(k)%ssi(m) = sed_idx(k)%ssi(m) - (-1.* sed_idx(k)%qsisum(m) + sed_idx(k)%Esi(m)*area_idx(k) - sed_idx(k)%Dsi(m)*area_idx(k)) * ddt/water_v_idx(k) !?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�ɖ߂�?�E��E�?�E��E�
				sed_idx(k)%Esi(m) = sed_idx(k)%qsisum(m)/area_idx(k)!E?�E��E�?�E��E�?�E��E�C?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�
!				sed_idx(k)%ssi(m) = sed_idx(k)%ssi(m) + (-1.* sed_idx(k)%qsisum(m) + sed_idx(k)%Esi(m)*area_idx(k) - sed_idx(k)%Dsi(m)*area_idx(k)) * ddt/water_v_idx(k) !?�E��E�V?�E��E�?�E��E�?�E��E�?�E��E�E?�E��E�?�E��E�?�E��E�g?�E��E�?�E��E�?�E��E�Ă�?�E��E�?�E��E�?�E��E�?�E��E�xssi?�E��E�?�E��E�?�E��E�v?�E��E�Z	 
				sed_idx(k)%ssi(m) = 0.d0
			endif	
...
!-----------?�E��E�?�E��E�?�E��E�ʂ̍Čv?�E��E�Z?�E��E�n?�E��E�?�E��E�----------------
...
!pause'in bedload'
!-----------?�E��E�?�E��E�?�E��E�ʂ̍Čv?�E��E�Z?�E��E�I?�E��E�?�E��E�----------------
!pause'1'
...
do k = 1, riv_count
	...
	!	   if(Emb_idx(k).ne.0.0) then
     ...
     !            u_flax = 0.d0
      !           else
				 u_flax = qr_ave_idx(k)/width_idx(k)/hr_idxa(k)
      !           endif    
	!?�E��E�}?�E��E�j?�E��E�?�E��E�?�E��E�O?�E��E�̑e?�E��E�x?�E��E�W?�E��E�?�E��E�?�E��E�?�E��E�p?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�C?�E��E�?�E��E�?�E��E�x?�E��E�̎Z?�E��E�?�E��E�
	...
	!?�E��E�?�E��E�?�E��E�ʌ�?�E��E�z?�E��E�?�E��E�p?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�C?�E��E�?�E��E�?�E��E�x?�E��E�̎Z?�E��E�?�E��E�
...
!                  ust_idx33 = ust_idx22 !?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�l?�E��E�?�E��E�?�E��E�̗p?�E��E�?�E��E�?�E��E�?�E��E��E�?
!			     else
!                 ust_idx33 = ust_idx1 !?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�?�E��E�l?�E��E�?�E��E�?�E��E�̗p?�E��E�?�E��E�?�E��E�?�E��E��E�?
!			     endif
...
!			     R_tcts = dsi/dsm * (1.28/(1.28+log10(dsi/dsm)))**2.
		...
		!MPM equation
		           if (ust_idx(k).gt.usci) then
		             ...
		             sed_idx(k)%qbi(m) = qbe*sqrt((s-1)*grav*dsi(m)**3.)*width_idx(k)*fp*alfa !?�E��E�P?�E��E�ʂ�m3/s
                   else
		             sed_idx(k)%qbi(m) = 0.0
	               end if 
...
!--------------------trasportation of suspended sediment
	...
	!				if(up_riv_lin(l,n) == 0) cycle !revised by Qin 2021/5/27
					if(up_riv_lin(l,n) == 0) exit 
					lll = up_riv_lin(l, n)
					sed_lin(l)%qsisum(m) = sed_lin(l)%qsisum(m) - sed_lin(lll)%qsi(m)*divloss !m3/s   !符号に注�E�?!!!  ffd �E�?-のとき�??積�?+のとき侵�E�? modified for diversion 20250329
				end do
...
!					if(up_riv_lin(l,n) == 0) cycle !revised by Qin 2021/5/27
					if(up_riv_lin(l,n) == 0) exit 
					lll = up_riv_lin(l, n)
					qwsum(l) = qwsum(l) - qw(lll)*divloss !m3/s   !符号に注�E�?!!!  ffd �E�?-のとき�??積�?+のとき侵�E�? modified for diversion 20250329
				end do
				qwsum(l) = qwsum(l) + qw(l)
			end if
		end if
		...
		elseif(n_link_depth(l)==1) then    !  In case of channel capasity loss due to deposition, pass sus_load to the downstream link  !20240229
				...
				do m =1,Np
					...
					if(sed_lin(l)%ssi(m).lt.0.d0) then
						...
						if(sed_lin(l)%Dsi(m) < 0.) sed_lin(l)%Dsi(m) = 0.d0 !ま�E�?Dが�?の時�?�E�上下流E��?�E�アンバランスによるのでDは0とな�E�?
...
!modified 20240115			
			...
			if(hki_g(k)>0.) exit	! no suspended sediment transportation taking place in debris flow grid cell; modified for gofukuya river 20240109	
				...
				if(up_slo_idx(k,n) == 0) exit 
					...
					slo_qsisum(k,m) = slo_qsisum(k,m) - slo_qsi(kkk,m)  !m3/s   !符号に注�E�?!!!  ffd �E�?-のとき�??積�?+のとき侵�E�? !modified 20230924
					endif
				end do		
			...
			!	if(water_v_cell(k).le.0.d0.or.hki_g(k)>0.)then !modified for gofukuya 20240109
				if(riv(i,j)==1 .or. water_v_cell(k).le.0.d0)then
					...
					if(slo_ssi(k,m).lt.0.d0) then
						...
						if(slo_Dsi(k,m)  < 0.) slo_Dsi(k,m)  = 0.d0 !ま�E�?Dが�?の時�?�E�上下流E��?�E�アンバランスによるのでDは0とな�E�?
						!if(slo_Dsi(k,m).le.1e-7) slo_Dsi(k,m) = 0.d0 !added 20240101						
						slo_ssi(k,m) = slo_ssi(k,m) + (-1.* slo_qsisum(k,m) + (slo_Esi(k,m)- slo_Dsi(k,m))*area)*ddt_slo/water_v_cell(k) !modified for inundation 20230711
...
!					write(*,*) 'kk,ao,vo',kk,ao,vo
					vo_total(slo_riv_idx(kk)) = vo    !こ�?�E�kは斜面のkであってrivのkではな�E�?
